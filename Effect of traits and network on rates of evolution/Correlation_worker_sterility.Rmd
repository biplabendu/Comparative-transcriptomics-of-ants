---
title: 'Correlation Worker sterility and rates of evolution'
...
# 4) Effects of network, expression level and worker sterility on the rates of evolution
```{r}
# Contrast Worker sterile
contrasts(x$Wsterility) <- contr.treatment(levels(x$Wsterility),base=3)
contrasts(x$Wsterility)
